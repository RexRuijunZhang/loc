...
class Clusterer:
    ...
    def add_point(self, point: np.ndarray, crop: np.ndarray) -> int:
    ...
    def add_batch(self, points: np.ndarray, crops: np.ndarray) -> List[int]:
        ...
        for point, crop in zip(points, crops):
            cluster_ids.append(self.add_point(point, crop))
        return cluster_ids
...
class Tracker:
    ...
    def track(
        ...
        cluster_ids = self.clusterer.add_batch(coord, crops)
